<!-- Página de productos de cerámica -->
<!DOCTYPE html>
<html  lang="es">
  <head>
    <meta charset="utf-8">
    ...
    <title>Cerámica | Maldita Carlita</title>
  ...
  <body>
    ...
    <!-- Cuerpo principal de la página con los productos de cerámica -->
    <main>
      <div class="max-w-6xl mx-auto px-6 py-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <!-- Mostrar productos con Modelo Producto -->
